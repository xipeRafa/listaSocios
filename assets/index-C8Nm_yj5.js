 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(e,t,r,i){this.indexId=e,this.collectionGroup=t,this.fields=r,this.indexState=i}}function Up(n){return n.fields.find(e=>e.kind===2)}function xi(n){return n.fields.filter(e=>e.kind!==2)}oh.UNKNOWN_ID=-1;class Ec{constructor(e,t){this.fieldPath=e,this.kind=t}}class Cl{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new Cl(0,tn.min())}}function tS(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,i=Y.fromTimestamp(r===1e9?new Re(t+1,0):new Re(t,r));return new tn(i,$.empty(),e)}function nS(n){return new tn(n.readTime,n.key,-1)}class tn{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new tn(Y.min(),$.empty(),-1)}static max(){return new tn(Y.max(),$.empty(),-1)}}function vg(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=$.comparator(n.documentKey,e.documentKey),t!==0?t:X(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nt(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=gw(e)),e=F1(n.get(t),e);return gw(e)}function F1(n,e){let t=e;const r=n.length;for(let i=0;i<r;i++){const s=n.charAt(i);switch(s){case"\0":t+="";break;case"":t+="";break;default:t+=s}}return t}function gw(n){return n+""}function Vn(n){const e=n.length;if(Q(e>=2),e===2)return Q(n.charAt(0)===""&&n.charAt(1)===""),ie.emptyPath();const t=e-2,r=[];let i="";for(let s=0;s<e;){const o=n.indexOf("",s);switch((o<0||o>t)&&G(),n.charAt(o+1)){case"":const a=n.substring(s,o);let u;i.length===0?u=a:(i+=a,u=i,i=""),r.push(u);break;case"":i+=n.substring(s,o),i+="\0";break;case"":i+=n.substring(s,o+1);break;default:G()}s=o+2}return new ie(r)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gS{}class se extends gS{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new uD(e,t,r):t==="array-contains"?new dD(e,r):t==="in"?new ES(e,r):t==="not-in"?new fD(e,r):t==="array-contains-any"?new pD(e,r):new se(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new cD(e,r):new hD(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(ui(t,this.value)):t!==null&&ns(this.value)===ns(t)&&this.matchesComparison(ui(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return G()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ce extends gS{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new ce(e,t)}matches(e){return Ao(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Ao(n){return n.op==="and"}function $p(n){return n.op==="or"}function Tg(n){return _S(n)&&Ao(n)}function _S(n){for(const e of n.filters)if(e instanceof ce)return!1;return!0}function qp(n){if(n instanceof se)return n.field.canonicalString()+n.op.toString()+So(n.value);if(Tg(n))return n.filters.map(e=>qp(e)).join(",");{const e=n.filters.map(t=>qp(t)).join(",");return`${n.op}(${e})`}}function yS(n,e){return n instanceof se?function(r,i){return i instanceof se&&r.op===i.op&&r.field.isEqual(i.field)&&$n(r.value,i.value)}(n,e):n instanceof ce?function(r,i){return i instanceof ce&&r.op===i.op&&r.filters.length===i.filters.length?r.filters.reduce((s,o,a)=>s&&yS(o,i.filters[a]),!0):!1}(n,e):void G()}function vS(n,e){const t=n.filters.concat(e);return ce.create(t,n.op)}function wS(n){return n instanceof se?function(t){return`${t.field.canonicalString()} ${t.op} ${So(t.value)}`}(n):n instanceof ce?function(t){return t.op.toString()+" {"+t.getFilters().map(wS).join(" ,")+"}"}(n):"Filter"}class uD extends se{constructor(e,t,r){super(e,t,r),this.key=$.fromName(r.referenceValue)}matches(e){const t=$.comparator(e.key,this.key);return this.matchesComparison(t)}}class cD extends se{constructor(e,t){super(e,"in",t),this.keys=IS("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class hD extends se{constructor(e,t){super(e,"not-in",t),this.keys=IS("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function IS(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>$.fromName(r.referenceValue))}class dD extends se{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return xl(t)&&Dl(t.arrayValue,this.value)}}class ES extends se{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Dl(this.value.arrayValue,t)}}class fD extends se{constructor(e,t){super(e,"not-in",t)}matches(e){if(Dl(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!Dl(this.value.arrayValue,t)}}class pD extends se{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!xl(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>Dl(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rA(n){var e,t;if(Q(n instanceof se||n instanceof ce),n instanceof se){if(n instanceof ES){const i=((t=(e=n.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(s=>se.create(n.field,"==",s)))||[];return ce.create(i,"or")}return n}const r=n.filters.map(i=>rA(i));return ce.create(r,n.op)}function JD(n){if(n.getFilters().length===0)return[];const e=Zp(rA(n));return Q(iA(e)),Jp(e)||Xp(e)?[e]:e.getFilters()}function Jp(n){return n instanceof se}function Xp(n){return n instanceof ce&&Tg(n)}function iA(n){return Jp(n)||Xp(n)||function(t){if(t instanceof ce&&$p(t)){for(const r of t.getFilters())if(!Jp(r)&&!Xp(r))return!1;return!0}return!1}(n)}function Zp(n){if(Q(n instanceof se||n instanceof ce),n instanceof se)return n;if(n.filters.length===1)return Zp(n.filters[0]);const e=n.filters.map(r=>Zp(r));let t=ce.create(e,n.op);return t=hh(t),iA(t)?t:(Q(t instanceof ce),Q(Ao(t)),Q(t.filters.length>1),t.filters.reduce((r,i)=>Vg(r,i)))}function Vg(n,e){let t;return Q(n instanceof se||n instanceof ce),Q(e instanceof se||e instanceof ce),t=n instanceof se?e instanceof se?function(i,s){return ce.create([i,s],"and")}(n,e):Qw(n,e):e instanceof se?Qw(e,n):function(i,s){if(Q(i.filters.length>0&&s.filters.length>0),Ao(i)&&Ao(s))return vS(i,s.getFilters());const o=$p(i)?i:s,a=$p(i)?s:i,u=o.filters.map(c=>Vg(c,a));return ce.create(u,"or")}(n,e),hh(t)}function Qw(n,e){if(Ao(e))return vS(e,n.getFilters());{const t=e.filters.map(r=>Vg(n,r));return ce.create(t,"or")}}function hh(n){if(Q(n instanceof se||n instanceof ce),n instanceof se)return n;const e=n.getFilters();if(e.length===1)return hh(e[0]);if(_S(n))return n;const t=e.map(i=>hh(i)),r=[];return t.forEach(i=>{i instanceof se?r.push(i):i instanceof ce&&(i.op===n.op?r.push(...i.filters):r.push(i))}),r.length===1?r[0]:ce.create(r,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lg{constructor(){this.Tr=new de(Ze.Er),this.dr=new de(Ze.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Ze(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Ze(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new $(new ie([])),r=new Ze(t,e),i=new Ze(t,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new $(new ie([])),r=new Ze(t,e),i=new Ze(t,e+1);let s=Z();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const t=new Ze(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Ze{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return $.comparator(e.key,t.key)||X(e.wr,t.wr)}static Ar(e,t){return X(e.wr,t.wr)||$.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DI=new Map;function Jt(n){An(n instanceof Function,"Expected a class definition");let e=DI.get(n);return e?(An(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,DI.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ts(n,e){return e?Jt(e):(z(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PF=z;class Wr{constructor(){this.browserResolver=Jt(rP),this.cordovaResolver=Jt(fF),this.underlyingResolver=null,this._redirectPersistence=pi,this._completeRedirectFn=Id,this._overrideRedirectResult=L_}async _initialize(e){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._initialize(e)}async _openPopup(e,t,r,i){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._openPopup(e,t,r,i)}async _openRedirect(e,t,r,i){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._openRedirect(e,t,r,i)}_isIframeWebStorageSupported(e,t){this.assertedUnderlyingResolver._isIframeWebStorageSupported(e,t)}_originValidation(e){return this.assertedUnderlyingResolver._originValidation(e)}get _shouldInitProactively(){return aP()||this.browserResolver._shouldInitProactively}get assertedUnderlyingResolver(){return PF(this.underlyingResolver,"internal-error"),this.underlyingResolver}async selectUnderlyingResolver(){if(this.underlyingResolver)return;const e=await TF();this.underlyingResolver=e?this.cordovaResolver:this.browserResolver}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v4="storage-compat";function w4(n,{instanceIdentifier:e}){const t=n.getProvider("app-compat").getImmediate(),r=n.getProvider("storage").getImmediate({identifier:e});return new jP(t,r)}function I4(n){const e={TaskState:Ct,TaskEvent:GU,StringFormat:cn,Storage:jP,Reference:cr};n.INTERNAL.registerComponent(new mn(v4,w4,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),n.registerVersion(_4,y4)}I4(Es);const H_=Es.initializeApp({apiKey:"AIzaSyB2F4R4KkxUwb4GFKs7twRhiHS5i-i51D4",authDomain:"scopic-73416.firebaseapp.com",projectId:"scopic-73416",storageBucket:"scopic-73416.appspot.com",messagingSenderId:"475263107333",appId:"1:475263107333:web:27180a036864e16618376c"});K2(H_);const lE=OV(H_);p4(H_);const Q_=Qt.createContext(),E4=n=>{const[e,t]=Qt.useState([]);console.log(e);const r=s_(lE,"caza"),[i,s]=Qt.useState(!0);Qt.useEffect(()=>{uR(r).then(a=>{a.size===0&&console.log("No results!");const u=a.docs.map(c=>({id:c.id,...c.data()}));t(u)}).catch(a=>{console.log("Error searching items",a)})},[i]);const o=async a=>{const u=Ul(lE,"caza",a);try{await cR(u)}catch(c){console.error(c)}};return re.jsx(Q_.Provider,{value:{items:e,deleteById:o,setToggle:s,toggle:i},children:n.children})},T4=({item:n})=>{const e=new Intl.DateTimeFormat("es-MX",{dateStyle:"long",timeStyle:"short"}),t=(o=0)=>e.format(new Date(o)),{deleteById:r,setToggle:i,toggle:s}=Qt.useContext(Q_);return re.jsx("div",{className:"card shadow-sm ",children:re.jsxs("div",{className:"card-body p-4 ",children:[re.jsxs("p",{children:[" ",t(n.idDate),"  "]}),re.jsx("hr",{}),re.jsxs("p",{children:[" ",re.jsx("span",{style:{color:"steelblue"},children:n.ren?"RENOVACIÓN":""})]}),re.jsxs("p",{children:["Nombre: ",re.jsx("span",{children:n.nombre})]}),re.jsxs("p",{children:["Correo: ",re.jsx("span",{children:n.correo})]}),re.jsxs("p",{children:["Telefono: ",re.jsx("span",{children:n.telefono})]}),re.jsx("hr",{}),re.jsx("div",{className:"btnBorrarInforme",children:re.jsx("button",{className:"btn btn-danger mb-2 mt-2",onClick:()=>{window.confirm(`Quiere Borrar este Socio? ${n.nombre}`)&&(r(n.id),i(!s))},children:n.ren?"Borrar Renovación":"Borrar Solicitud"})})]})})},S4=()=>{const{items:n,setToggle:e,toggle:t}=Qt.useContext(Q_),[r,i]=Qt.useState(0);let s=8;const[o,a]=Qt.useState(""),[u,c]=Qt.useState(!0),[d,f]=Qt.useState(!0),m=y=>{f(y),e(!t)};return re.jsxs("div",{className:"",children:[re.jsx("h2",{className:"listaH2",children:"Lista de Solicitudes de Inscripción"}),re.jsxs("section",{children:[re.jsx("button",{className:"buttonRen",onClick:()=>m(!1),children:"Solicitudes"}),re.jsx("button",{className:"buttonRen",onClick:()=>m(!0),children:"Renovaciones"})]}),re.jsx("div",{className:"row row-cols-1 row-cols-md-3 row-cols-lg-4 p-5 g-3 border",children:n.sort((y,R)=>y.idDate-R.idDate).filter(y=>y.ren===d).slice(r,r+s).map((y,R)=>re.jsx(T4,{item:y},R))}),re.jsxs("div",{className:"sliceButtons",children:[re.jsx("button",{className:r===0?"d-none":"button",onClick:()=>{r>0&&(i(r-s),window.scrollTo(0,0))},children:"⇦ Anterior"}),re.jsx("button",{className:r===s||r===0?"d-none":"button",onClick:()=>{i(0),window.scrollTo(0,0)},children:"０"}),re.jsx("button",{className:"button",onClick:()=>{n.length>r+s?(i(r+s),window.scrollTo(0,0)):(a(" No Hay Mas Socios"),setTimeout(()=>{a("")},2500))},children:"Siguiente ⇨"}),re.jsx("span",{className:"sliceAlert",children:o}),re.jsxs("p",{className:"sliceButtonsP",children:["De: ",r+1," a: ",n.length>r+s?r+s:n.length]}),re.jsxs("p",{className:"sliceButtonsP",children:["Paginas de ",s," c/u "]})]})]})},A4=()=>re.jsx(re.Fragment,{children:re.jsx(E4,{children:re.jsx(S4,{})})});jf.createRoot(document.getElementById("root")).render(re.jsx(Lk.StrictMode,{children:re.jsx(A4,{})}));
